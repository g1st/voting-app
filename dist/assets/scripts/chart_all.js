...
var listPolls = function listPolls(data, callback) {
  data.forEach(function (poll) {
    container.innerHTML += '<div class="flex_container__list"><canvas id="' + poll._id + '" width="420" height="420"></canvas><div id="view' + poll._id + '" class="poll_view"><a href="/polls/' + poll._id + '">View</a></div></div>';
  });
  callback(data);
};
